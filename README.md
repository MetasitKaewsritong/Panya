...
## 3. 💾 การกู้คืนฐานข้อมูล (Restoring the Database)
...
หลังจากกู้คืนฐานข้อมูลแล้ว คุณสามารถสตาร์ทระบบทั้งหมดได้
...
### 5.2 (Optional) ล้างข้อมูลเก่า (Clear Database)

หากคุณต้องการล้างความรู้เก่าทั้งหมดทิ้งก่อน (เช่น กรณีอัปเดตไฟล์เวอร์ชันใหม่) ให้รันคำสั่งนี้:
```bash
docker compose exec postgres psql -U user -d plcnextdb -c "TRUNCATE TABLE documents;"